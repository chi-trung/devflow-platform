...
/// description, status, and the project's weighted knowledge base. An optional
/// free-text Prompt adds a user focus line on top of that context. The generated
...
public sealed record PlanTaskCommand(
    ...
    Guid ProjectId,
    Guid TaskId,
    string? Prompt = null) : IRequest<AiPlanResponse>, IWorkspaceRequest, IProjectEvent
{
